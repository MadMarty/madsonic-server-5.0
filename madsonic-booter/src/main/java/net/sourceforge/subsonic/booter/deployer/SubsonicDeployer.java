 ...
 * <ul>
 * <li><code>subsonic.contextPath</code> - The context path at which Madsonic is deployed.  Default "/".</li>
 * <li><code>subsonic.port</code> - The port Madsonic will listen to.  Default 4040.</li>
 * <li><code>subsonic.httpsPort</code> - The port Madsonic will listen to for HTTPS.  Default 0, which disables HTTPS.</li>
 * <li><code>madsonic.war</code> - Madsonic WAR file, or exploded directory.  Default "madsonic.war".</li>
 * <li><code>subsonic.createLinkFile</code> - If set to "true", a Madsonic.url file is created in the working directory.</li>
...
public class SubsonicDeployer implements SubsonicDeployerService {
    ...
    public static final int DEFAULT_MEMORY_INIT = 128;
    public static final int DEFAULT_MEMORY_LIMIT = 256;
