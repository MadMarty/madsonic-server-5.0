    ...
    private void setupIcons() {
        ...
        try {
            ...
            java.util.List<Image> images = Arrays.asList(
                    toolkit.createImage(Main.class.getResource("/images/madsonic-16.png")),
                    toolkit.createImage(Main.class.getResource("/images/madsonic-32.png")),
                    toolkit.createImage(Main.class.getResource("/images/madsonic-512.png")));
            method.invoke(this, images);
        } catch (Throwable x) {
            // Fallback to old method.
            setIconImage(toolkit.createImage(Main.class.getResource("/images/madsonic-32.png")));
        }
    }
