...
<head>
    ...
    <script type="text/javascript" language="javascript">
		...
		modes: [
			{ type: 'html5' },
			{ type: 'flash', src: '/flash/jw-player-6.6' }
		]
            };
            var params = {
	    ...
	    swfobject.embedSWF("<c:url value="/flash/jw-player-6.6.swf"/>", "placeholder1", flashvars.width, flashvars.height, "9.0.0", false, flashvars, params, attributes);
        }
