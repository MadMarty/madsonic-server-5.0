...
<table style="padding-top:1em;padding-bottom:2em;width:60%">
    ...
    <tr>
        <td style="font-size:26pt;padding:20pt">4</td>
        <td>
            <div style="font-size:14pt"><a href="groupSettings.view"><fmt:message key="gettingStarted.step4.title"/></a></div>
            <div style="padding-top:5pt"><fmt:message key="gettingStarted.step4.text"/></div>
        </td>
    </tr>
    <tr>
        <td style="font-size:26pt;padding:20pt">5</td>
        <td>
            <div style="font-size:14pt"><a href="accessSettings.view"><fmt:message key="gettingStarted.step5.title"/></a></div>
            <div style="padding-top:5pt"><fmt:message key="gettingStarted.step5.text"/></div>
        </td>
    </tr>	
</table>
