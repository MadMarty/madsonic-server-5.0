...
<html><head>
    ...
    <c:if test="${model.lyrics eq null}">    
...
<table>
    <tr>
        ...
        <td style="padding-left:0.75em"><input type="submit" value="<fmt:message key="lyrics.search"/>" style="width:6em" tabindex="3"/></td>
    </tr>
    <tr>
		...
		<!-- <td style="padding-left:0.75em"><input type="button" value="<fmt:message key="common.close"/>" style="width:6em" onclick="self.close()" tabindex="4"/></td> -->
    </tr>
</table>
</form>
<hr/>
...
<c:if test="${model.lyrics ne null}">
