...
<html><head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function setImage(imageUrl) {
			...
			var isArtist = dwr.util.getValue("isArtist");
			
			if (isArtist)
			{ coverArtService.setCoverArtImage(id, imageUrl, true, setImageComplete);
			} else
			{ coverArtService.setCoverArtImage(id, imageUrl, false, setImageComplete);
			}
		}
...
<form action="javascript:setImage(dwr.util.getValue('url'))">
    <table><tr>
        ...
        <input id="isArtist" type="hidden" name="isArtist" value="${model.isArtist}"/>
