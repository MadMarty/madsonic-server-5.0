...
<script type="text/javascript" language="javascript">
    ...
    function updateNextTag() {
        ...
        tagService.setTags(id, track, artist, albumartist, album, title, year, mood, genre, setTagsCallback);
    }
...
<table class="ruleTable indent">
    ...
    <tr>
        ...
        <th class="ruleTableHeader" style="white-space: nowrap"><input type="text" name="artistAll" size="15" onKeyPress="dwr.util.onReturn(event, setArtist)" value="${model.defaultArtist}"/></th>
        <th class="ruleTableHeader" style="white-space: nowrap"><input type="text" name="albumartistAll" size="15" onKeyPress="dwr.util.onReturn(event, setAlbumArtist)" value="${model.defaultAlbumArtist}"/></th>
        <th class="ruleTableHeader" style="white-space: nowrap"><input type="text" name="albumAll" size="15" onKeyPress="dwr.util.onReturn(event, setAlbum)" value="${model.defaultAlbum}"/></th>
        ...
        <th class="ruleTableHeader" style="white-space: nowrap">
            <select name="moodAll" style="width:7em">
                <option value=""/>
    ...
    <c:forEach items="${model.songs}" var="song" varStatus="loopStatus">
        <tr>
          <td colspan="9" align="left" valign="middle" class="ruleTableCell" title="${song.fileName}"><strong>${song.fileName}</strong></td>
        </tr>
        <tr>
<!--        <str:truncateNicely lower="45" upper="45" var="fileName">${song.fileName}</str:truncateNicely> -->
            ...
            <td class="ruleTableCell"><input type="text" name="mood${loopStatus.count - 1}" value="${song.mood}" style="width:7em"/></td>
