...
public class RatingService {
     ...
     */
    public List<MediaFile> getHighestRated(int offset, int count, int user_group_id) {
        List<String> highestRated = ratingDao.getHighestRated(offset, count, user_group_id);
