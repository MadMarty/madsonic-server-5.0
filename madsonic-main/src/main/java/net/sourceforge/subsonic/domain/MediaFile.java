...
public class MediaFile {
    ...
    public MediaFile(int id, String path, String folder, MediaType mediaType, boolean override, String format, String title,
 ...
 //     return !isFile();
        return mediaType == MediaType.DIRECTORY || mediaType == MediaType.ALBUMSET || mediaType == MediaType.ALBUM || mediaType == MediaType.ARTIST || mediaType == MediaType.MULTIARTIST;
    }

    public boolean isFile() {
 //   return mediaType != MediaType.DIRECTORY && mediaType != MediaType.ALBUM;
      return mediaType != MediaType.DIRECTORY && mediaType != MediaType.ALBUM && mediaType != MediaType.ALBUMSET && mediaType != MediaType.ARTIST && mediaType != MediaType.MULTIARTIST;
    }
