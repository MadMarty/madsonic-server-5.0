...
public class MusicFolder implements Serializable {
     ...
     */
    public MusicFolder(Integer id, File path, String name, boolean enabled, Date changed, Integer index) {
        this.id = id;
        this.path = path;
        this.name = name;
        isEnabled = enabled;
     ...
     * @param changed When the corresponding database entry was last changed.
     */
    public MusicFolder(File path, String name, boolean enabled, Date changed, Integer index) {
        this(null, path, name, enabled, changed, index);
    }
