...
public class PlayQueue {
    ...
    /**
	 * @return the pandoraEnabled
	 */
	public synchronized boolean isPandoraEnabled() {
		return pandoraEnabled;
	}

	/**
	 * @param pandoraEnabled the pandoraEnabled to set
	 */
	public synchronized void setPandoraEnabled(boolean pandoraEnabled) {
     ...
     *
     * @param criteria The search criteria, or <code>null</code> if this is not a random playlist.
     */
    public synchronized void setRandomSearchCriteria(RandomSearchCriteria criteria) {
        this.randomSearchCriteria = criteria;
    }
