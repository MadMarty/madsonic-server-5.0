...
import net.sourceforge.subsonic.dao.schema.Schema47Upgrade;
import net.sourceforge.subsonic.dao.schema.SchemaMadsonic;
import net.sourceforge.subsonic.dao.schema.SchemaLastFM;
