...
public class VideoPlayerController extends ParameterizableViewController {
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        map.put("maxBitRate", ServletRequestUtils.getIntParameter(request, "maxBitRate", userDefaultBitrate)); // DEFAULT_BIT_RATE));
        ...
        if (settingsService.isHTML5PlayerEnabled()) {
	        result.setViewName("videoPlayerH5");
        }
        return result;
    }
