...
public class LeftController extends ParameterizableViewController {
    ...
    static {
        LAST_COMPATIBILITY_TIME.set(2013, Calendar.DECEMBER, 1, 0, 0, 0);
...
//      map.put("sortMediaFileFolder", settingsService.isSortMediaFileFolder());
    ...
    public MusicFolderContent getMusicFolderContent(List<MusicFolder> musicFoldersToUse, String genre, boolean refresh) throws Exception {
    	int usedIndex = 1;
