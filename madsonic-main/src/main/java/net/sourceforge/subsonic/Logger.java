...
import net.sourceforge.subsonic.domain.LogLevel;


/**
 * Logger implementation which logs to SUBSONIC_HOME/madsonic.log. <br/>
...
public class Logger {
	...
	public static File getLogFile() {
		...
		return new File(subsonicHome, "madsonic.log");
	}
